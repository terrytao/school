            ...
            <div class="section-container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-md-5">
                        <div class="biothumb">
                            <img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/personal/personal-big.png" class="img-responsive">
                            <div class="overlay">
                        ...
                        <ul class="timeline">
                            ...
                            <li class="open">
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-2">
                                            <img alt="image" class="thumbnail img-responsive" src="<?=Yii::$app->view->theme->baseUrl;?>/img/personal/awards100x100.png" >
                                        </div>
                                        <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div id="labp-heads-wrap">
                            ...
                            <div id="lab-carousel">
                                <div><img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/lab/120x120.png" width="120" height="120" class="img-circle lab-img" /></div>
                                <div><img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/lab/120x120.png" width="120" height="120" class="img-circle lab-img" /></div>
                                <div><img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/lab/120x120.png" width="120" height="120" class="img-circle lab-img" /></div>
                                <div><img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/lab/120x120.png" width="120" height="120" class="img-circle lab-img" /></div>
                                <div><img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/lab/120x120.png" width="120" height="120" class="img-circle lab-img" /></div>
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-sm-6 col-md-3">
                                        <div class="image">
                                            <img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/lab/400x400.png" class="img-responsive">
                        ...
                        <div class="col-md-12">
                            <div class="pitems">
                                ...
                                <div class="item mix book" data-year="2010">
                                    ...
                                    <div class="pubdetails">
                                        <img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/pubs/150x200.png" align="left"  style="padding:0 30px 30px 0;">
        ...
        <div class="section color-3" id="gallery-large">
            <div class="section-container">
                ...
                <ul id="grid" class="grid">
                    <li>
                        <div>
                            <img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/450x600.png">
                            <a href="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/450x600.png" class="popup-with-move-anim">
                                <div class="over">
                                    <div class="comein">
                    ...
                    <li>
                        <div>
                            <img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/600x600.png">
                            <a href="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/600x500.png" class="popup-with-move-anim">
                                <div class="over">
                                    <div class="comein">
                                        <h3>Image Title</h3>
                    ...
                    <li>
                        <div>
                            <img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/900x600.png">
                            <a href="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/900x600.png" class="popup-with-move-anim">
                                <div class="over">
                                    <div class="comein">
                                        <i class="icon-search"></i>
                                        <div class="comein-bg"></div>
                    ...
                    <li>
                        <div>
                            <img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/400x300.png">
                            <a href="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/400x300.png" class="popup-with-move-anim">
                                <div class="over">
                                    <div class="comein">
                                        <h3>Image Title</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    ...
                    <li>
                        <div>
                            <img alt="image" src="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/800x600.png">
                            <a href="<?=Yii::$app->view->theme->baseUrl;?>/img/gallery/800x600.png" class="popup-with-move-anim">
                                <div class="over">
                                    <div class="comein">
                                        <h3>Image Title</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
