...
<script>
    var galleryUploader = new qq.FineUploader({
        ...
        multiple: false,
        request: {
            endpoint: '<?=Yii::$app->urlManager->createUrl(['/profile/upload']);?>'
        },
        thumbnails: {
            placeholders: {
        ...
        callbacks: {
            onComplete: function (id, name, responseJSON, xhr) {
                ...
                console.log(responseJSON.crop);
                $('#cropContainer').html(responseJSON.crop);
                $('.qq-uploader').before('<div class="alert alert-success">Image uploaded</div>')
                $('.qq-uploader').hide();
            }
        },
    });
