                            ...
                            <div class="row">
                                <div class="col-xs-">
                                    <div class="widget-box widget-color-blue">
                                        <div class="widget-header">
                                            <h4 class="widget-title lighter smaller">Schools Selected</h4>
                                        </div>
                                    <table id="simple-table" class="table table-striped table-bordered table-hover">
                                        <thead>
                                        <tr>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main padding-8">
                                            <div class="control-group">
                                                ...
                                                <button class="btn btn-danger">Go Back (preview page, all the tables above don't have checkboxes or action buttons)</button>
