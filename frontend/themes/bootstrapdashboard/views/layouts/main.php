        ...
        <div class="navbar-container">
            ...
            <div class="navbar-header pull-left">
                <a href="#" class="navbar-brand">
                    <small>
                        <img src="<?= $theme->getUrl('assets/img/logo.png'); ?>" alt=""/>
                    </small>
                </a>
            </div>
            <!-- /Navbar Barnd -->
                    ...
                    <ul class="account-area">
                        ...
                        <li>
                            ...
                            <ul class="pull-right dropdown-menu dropdown-arrow dropdown-messages">
                                <li>
                                    <a href="#">
                                        <img src="<?= $theme->getUrl('assets/img/avatars/divyia.jpg'); ?>"
                                ...
                                <li>
                                    <a href="#">
                                        <img src="<?= $theme->getUrl('assets/img/avatars/bing.png'); ?>"
                                ...
                                <li>
                                    <a href="#">
                                        <img src="<?= $theme->getUrl('assets/img/avatars/adam-jansen.jpg'); ?>"
                                             class="message-avatar"
                                             alt="Divyia Austin">
                        ...
                        <li>
                            <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                ...
                                <section>
                                    <h2><span class="profile"><span><?= @$this->params['layoutStudentName'];?></span></span></h2>
                                </section>
                            </a>
                            <!--Login Area Dropdown-->
        ...
        <div id="chatbar" class="page-chatbar">
            <div class="chatbar-contacts">
                ...
                <ul class="contacts-list">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="<?= $theme->getUrl('assets/img/avatars/Nicolai-Larson.jpg')?>"/>
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="<?= $theme->getUrl('assets/img/avatars/John-Smith.jpg');?>"/>
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="<?= $theme->getUrl('assets/img/avatars/Osvaldus-Valutis.jpg');?>"/>
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="<?= $theme->getUrl('assets/img/avatars/Javi-Jimenez.jpg');?>"/>
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="<?= $theme->getUrl('assets/img/avatars/Stephanie-Walter.jpg');?>"/>
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="<?= $theme->getUrl('assets/img/avatars/Sergey-Azovskiy.jpg');?>"/>
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="<?= $theme->getUrl('assets/img/avatars/Lee-Munroe.jpg');?>"/>
                        </div>
                        <div class="contact-info">
